...
@section('page-title', 'Dashboard Tenaga Pendidik')
        ...
        <div class="card">
            ...
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4">
                    Anda login sebagai Tenaga Pendidik di Sistem Informasi Surat-Menyurat<br>
                    Dinas Pendidikan dan Kebudayaan Purworejo
                </p>
